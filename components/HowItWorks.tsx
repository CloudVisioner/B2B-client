    ...
    <section id="how-it-works" className="py-24 bg-slate-50/50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-500">Streamlining B2B collaborations for buyers and providers.</p>
        </div>
        ...
        <div className="mb-16">
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="text-base font-bold tracking-[0.2em] text-indigo-500 uppercase">For Buyers</span>
            <div className="h-px flex-grow bg-indigo-100"></div>
          </div>
        ...
        <div>
          <div className="flex items-center gap-4 mb-8">
            <div className="h-px flex-grow bg-indigo-100"></div>
            <span className="text-base font-bold tracking-[0.2em] text-indigo-500 uppercase">For Providers</span>
            <div className="h-px flex-grow bg-indigo-100"></div>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <StepCard 
