  ...
  return (
    <div className="bg-slate-50 min-h-screen py-10">
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-slate-900 mb-4">Browse Expert Providers</h1>
          <p className="text-lg text-slate-500 max-w-2xl">Find verified agencies and independent professionals with proven track records in enterprise transformation.</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-2">
                <button 
                  ...
                  className={`text-left px-4 py-3 rounded-xl border text-base font-semibold transition-all ${activeCat === 'all' ? 'bg-indigo-600 border-indigo-600 text-white shadow-lg' : 'bg-white text-slate-600 hover:border-indigo-100'}`}
                >
                  All Categories
                </button>
                {CATEGORIES.map(cat => (
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <select 
                  ...
                  className="w-full appearance-none bg-white border border-slate-200 rounded-lg py-3 pl-4 pr-10 text-base focus:outline-none cursor-pointer"
                >
                  {COUNTRIES.map(c => (
          ...
          <div className="flex-1 w-full">
            <div className="space-y-3 mb-8">
              ...
              <div 
                key={p.id} 
                className="bg-white border border-slate-200 rounded-xl hover:border-indigo-300 hover:shadow-lg transition-all duration-200 group"
