    ...
    <section className="pt-24 pb-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <div className="inline-flex items-center px-3 py-1 rounded-full bg-indigo-50 border border-indigo-100 mb-6">
          ...
          <span className="text-xs font-bold uppercase tracking-widest text-indigo-600">The Marketplace for Growth</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          ...
          <button 
            ...
            className="w-full sm:w-auto px-8 py-4 text-base text-indigo-600 font-bold border-2 border-indigo-100 rounded-full hover:bg-indigo-50 transition-all"
          >
            I want to Work
          </button>
        </div>
        ...
        <div className="mt-12">
          <p className="text-xs text-slate-400 font-semibold uppercase tracking-widest mb-6">Trusted by leading companies</p>
